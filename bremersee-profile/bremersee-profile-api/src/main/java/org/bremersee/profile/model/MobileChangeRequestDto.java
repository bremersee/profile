...
@XmlRootElement(name = "mobileChangeRequest")
@XmlType(name = "mobileChangeRequestType", propOrder = {
        "changeHash",
        "changeExpiration",
        "uid",
        "newMobile"
...
//@formatter:on
public class MobileChangeRequestDto extends AbstractBaseDto {
    ...
    @XmlElement(name = "newMobile", required = true)
    @ApiModelProperty(required = true)
